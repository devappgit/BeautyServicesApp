 ...
 *
 * Note the addition of a {@link BeautyservicesMobileApiInterceptor},
 ...
 */
public class BeautyservicesHttpClient {

    @SuppressWarnings("ConstantConditions")
    public static String baseUrl() {
        return BuildConfig.DEV ? "https://dev.Beautyservices.com/" : "https://www.Beautyservices.com/";
    }
        ...
        if (retrofit == null) {
            retrofit = new Retrofit.Builder()
                    ...
                    .client(getClient().newBuilder()
                            .addInterceptor(new BeautyservicesMobileApiInterceptor())    // add Beautyservices X-Requested-With & User-Agent headers
